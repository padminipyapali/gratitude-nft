...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    kovan: {
      url: "https://kovan.infura.io/v3/7d7e7fedbfb04c27b55ef19358814bf2",
      accounts: {
        mnemonic: getMnemonic(),
      },
    },
    mainnet: {
      url: "https://mainnet.infura.io/v3/7d7e7fedbfb04c27b55ef19358814bf2",
      accounts: {
        mnemonic: getMnemonic(),
      },
    },
    ropsten: {
      url: "https://ropsten.infura.io/v3/7d7e7fedbfb04c27b55ef19358814bf2",
      accounts: {
        mnemonic: getMnemonic(),
      },
    },
